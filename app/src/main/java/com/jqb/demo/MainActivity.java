...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] urls3 = {
            "http://leke-door.oss-cn-shenzhen.aliyuncs.com/audio/1601/156//110238826182.wav?v=1534474959",
            "http://leke-door.oss-cn-shenzhen.aliyuncs.com/audio/1601/156//110239132046.wav?v=1534474959",
            "http://leke-door.oss-cn-shenzhen.aliyuncs.com/audio/1601/156//110239123987.wav?v=1534474959",
            "http://leke-door.oss-cn-shenzhen.aliyuncs.com/audio/1601/156//110239695690.wav?v=1534474959",
            "http://leke-door.oss-cn-shenzhen.aliyuncs.com/audio/1601/156//110239473902.wav?v=1534474959"
    };
    ...
    private String[] urls2 = {
            "http://leke-door.oss-cn-shenzhen.aliyuncs.com/audio/1601/217//144421915711.wav?v=1534488261",
            "http://leke-door.oss-cn-shenzhen.aliyuncs.com/audio/1601/217//144421859211.wav?v=1534488261",
            "http://leke-door.oss-cn-shenzhen.aliyuncs.com/audio/1601/217//14442152183.wav?v=1534488261",
            "http://leke-door.oss-cn-shenzhen.aliyuncs.com/audio/1601/217//14442170251.wav?v=1534488261",
            "http://leke-door.oss-cn-shenzhen.aliyuncs.com/audio/1601/217//144421204224.wav?v=1534488261",
            "http://leke-door.oss-cn-shenzhen.aliyuncs.com/audio/1601/217//144421481796.wav?v=1534488262",
            "http://leke-door.oss-cn-shenzhen.aliyuncs.com/audio/1601/217//144422471004.wav?v=1534488262",
            "http://leke-door.oss-cn-shenzhen.aliyuncs.com/audio/1601/217//144422935937.wav?v=1534488262"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bunchDir = new File(getParentFile(this), "bunch");
        Log.e("MainActivity", "bunchDir.getPath()= " + bunchDir);
    ...
    private void download(String[] urls) {
        ...
        Log.d("MainActivity", "before bind bunch task consume " + (SystemClock.uptimeMillis() - startTime) + "ms");
        for (String url: urls) {
        ...
        Log.d("MainActivity", "before build bunch task consume " + (SystemClock.uptimeMillis() - startTime) + "ms");
        downloadContext = builder.setListener(new DownloadContextListener() {
            ...
            public void queueEnd(@NonNull DownloadContext context) {
                Log.e("MainActivity", "queueEnd");
            }
        }).build();

        Log.d("MainActivity", "before bunch task consume " + (SystemClock.uptimeMillis() - startTime) + "ms");
        downloadContext.start(listener, true);
        Log.d("MainActivity", "start bunch task consume " + (SystemClock.uptimeMillis() - startTime) + "ms");
    }
    ...
    private void initListener() {
        listener = new DownloadListener1() {
            ...
            public void taskStart(@NonNull DownloadTask task,
                ...
                Log.e("MainActivity", "taskStart");
            }

            @Override
            public void retry(@NonNull DownloadTask task, @NonNull ResumeFailedCause cause) {
                Log.e("MainActivity", "retry");
            }
            ...
            public void progress(@NonNull DownloadTask task, long currentOffset, long totalLength) {
                Log.e("MainActivity", "currentOffset= " + currentOffset);
                Log.e("MainActivity", "totalLength= " + totalLength);
            }
            ...
            public void taskEnd(@NonNull DownloadTask task, @NonNull EndCause cause,
                                ...
                                @NonNull Listener1Assist.Listener1Model model) {
                Log.e("MainActivity", "taskEnd= " + task + " end " + cause);
                currentCount += 1;
                updateBunchInfoAndProgress();
            }
        };
